...
ICD10_CM: dict[str, tuple[str, str, str]] = {
    ...
    "C90.0": ("C90.0", "Multiple myeloma", "Neoplasm"),
    "D70.1": ("D70.1", "Agranulocytosis secondary to cancer chemotherapy", "Blood"),
    "N18.2": ("N18.2", "Chronic kidney disease, stage 2 (mild)", "Genitourinary"),
    "Z79.899": ("Z79.899", "Other long term (current) drug therapy", "Factors"),
    ...
    "E10.1": ("E10.1", "Type 1 diabetes mellitus with ketoacidosis", "Endocrine"),
    "E10.10": ("E10.10", "Type 1 diabetes mellitus with ketoacidosis without coma", "Endocrine"),
    "E10.11": ("E10.11", "Type 1 diabetes mellitus with ketoacidosis with coma", "Endocrine"),
    "E11.1": ("E11.1", "Type 2 diabetes mellitus with ketoacidosis", "Endocrine"),
    "E11.10": ("E11.10", "Type 2 diabetes mellitus with ketoacidosis without coma", "Endocrine"),
    "E11.11": ("E11.11", "Type 2 diabetes mellitus with ketoacidosis with coma", "Endocrine"),
...
CPT_CODES: dict[str, tuple[str, str, str]] = {
    ...
    "38205": ("38205", "Blood-derived hematopoietic progenitor cell harvesting for transplantation, perday; apheresis", "Surgery"),
    "38241": ("38241", "Bone marrow or blood-derived peripheral stem cell transplantation; autologous", "Surgery"),
    "96413": ("96413", "Chemotherapy administration, intravenous infusion technique; up to 1 hour", "Medicine"),
...
ICD10_COSTS: dict[str, float] = {
    ...
    "C71.9": 68000.0, "C73": 16000.0, "C79.51": 32000.0, "C90.00": 48000.0, "C90.0": 48000.0, "D70.1": 15000.0, "N18.2": 4500.0, "Z79.899": 2500.0,
    "D17.9": 2200.0,
    # Blood
    ...
    "E10.1": 9500.0, "E10.10": 9500.0, "E10.11": 12000.0,
    "E11.1": 9500.0, "E11.10": 9500.0, "E11.11": 12000.0,
...
CPT_COSTS: dict[str, float] = {
    ...
    "44970": 8500.0, "38205": 15000.0, "38241": 25000.0, "96413": 850.0,
    "47562": 9500.0, "47563": 10500.0,
